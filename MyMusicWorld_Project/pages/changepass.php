  ...
  if ($npass === $cpass){
    ...
    if($result->num_rows > 0){
      ...
      $passres = $row['password'];
          ...
          if($passres == $pass){
            $update = "UPDATE user SET password = '$npass' WHERE id=$id";
  ...
  <div class="pt-10 pb-9 md:pt-16 md:pb-14">
    ...
    <div class="text-center">
      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="w-full">
            <input id="pass" type= "password" placeholder="Your old password" name="pass" class="text-gray-900 font-medium inline-flex items-center justify-center border border-transparent rounded leading-snug transition duration-150 ease-in-out px-3 py-3 shadow-sm hover:shadow-lg w-full sm:w-1/2 mb-4 sm:mb-0" required></input>
          </div>
        </div>

        <div class="max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center mb-3">
        <div class="w-full">
            <input id="npass" type= "text" placeholder="Your new password" name="npass" class="text-gray-900 font-medium inline-flex items-center justify-center border border-transparent rounded leading-snug transition duration-150 ease-in-out px-3 py-3 shadow-sm hover:shadow-lg w-full sm:w-1/2 mb-4 sm:mb-0" required></input>
          </div>
        </div>

        <div class="max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center mb-5">
        <div class="w-full">
            <input id="cpass" type= "password" placeholder="Confirm new password" name="cpass" class="text-gray-900 font-medium inline-flex items-center justify-center border border-transparent rounded leading-snug transition duration-150 ease-in-out px-3 py-3 shadow-sm hover:shadow-lg w-full sm:w-1/2 mb-4 sm:mb-0" required></input>
          </div>
        </div>
